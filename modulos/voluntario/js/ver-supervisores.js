...
if (!viewContentArea || !dashboardContent || !supervisorCardsGrid) {
    ...
    async function loadSupervisorSubView(viewName) {
        ...
        const fileMap = {
            // 'meu_perfil': { html: 'page/view-meu-perfil.html', js: 'js/view-meu-perfil.js' }, // Desativado temporariamente
            'meus_supervisionados': { html: 'page/view-meus-supervisionados.html', js: 'js/view-meus-supervisionados.js' }
            // 'meus_agendamentos': { html: 'page/view-meus-agendamentos.html', js: 'js/view-meus-agendamentos.js' } // Desativado temporariamente
        };
        // ============================
