...
// Descrição: Adiciona lógica para renderizar o cabeçalho dinâmico e tratamento de erro para imagem de perfil.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function renderLayoutAndContent(user, userData) {
        ...
        if (userPhoto) {
            // Define a imagem do usuário ou a imagem padrão que pode falhar
            userPhoto.src = user.photoURL || 'https://www.eupsico.org.br/wp-content/uploads/2024/02/user-1.png';

            // Adiciona um "plano B": se a imagem não carregar, executa esta função
            userPhoto.onerror = function() {
                this.onerror = null; // Previne loops infinitos se a imagem padrão também falhar
                
                // Coloque aqui o caminho para um avatar padrão QUE EXISTA no seu projeto
                this.src = '../../../assets/img/avatar-padrao.png'; 
            };
        }
        // *** FIM DA CORREÇÃO ***
